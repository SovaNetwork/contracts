      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mt-12 grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
          <div className="defi-card p-6">
            <h3 className="text-lg font-semibold mb-3 text-sova-mint-400">🔄 Token Wrapping</h3>
          ...
          <div className="defi-card p-6">
            <h3 className="text-lg font-semibold mb-3 text-sova-mint-500">🔓 Token Unwrapping</h3>
            <p className="text-sm text-foreground/70">
          ...
          <div className="defi-card p-6">
            <h3 className="text-lg font-semibold mb-3 text-sova-mint-600">🌉 Cross-Chain Bridging</h3>
            <p className="text-sm text-foreground/70">
        ...
        <div className="mt-8 text-center">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-card/50 border border-border/50 rounded-lg">
            <div className="w-2 h-2 bg-sova-mint-400 rounded-full animate-pulse"></div>
