...
contract SovaBTCOFT is ERC20, Ownable, ReentrancyGuard, ISovaBTC {
    ...
    constructor(string memory _name, string memory _symbol, address _endpoint, address _minter) ERC20(_name, _symbol) {
        ...
        returns (MessagingReceipt memory msgReceipt, OFTReceipt memory oftReceipt)
    {
        ...
        msgReceipt = MessagingReceipt({guid: guid, nonce: uint64(block.number), fee: _fee});
