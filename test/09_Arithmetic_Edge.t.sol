...
contract ArithmeticEdgeTest is Test {
    ...
    function test_RedemptionPrecisionLoss() public {
        ...
        vm.expectRevert(
            abi.encodeWithSelector(
                TokenWrapper.InsufficientReserve.selector, address(lowPrecToken), fractionalAmount, 0
            )
        );
    ...
    function test_MinimumDepositBoundary() public {
        ...
        // Should revert
        vm.expectRevert(abi.encodeWithSelector(TokenWrapper.DepositBelowMinimum.selector, 9999, 10000));
