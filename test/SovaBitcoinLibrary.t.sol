...
contract SovaBitcoinLibraryTest is Test {
    ...
    function test_LibraryConstants() public pure {
        ...
        assertEq(SovaBitcoin.SOVA_L1_BLOCK_ADDRESS, 0x2100000000000000000000000000000000000015, "SOVA_L1_BLOCK_ADDRESS should be correct");
        ...
        assertEq(SovaBitcoin.ADDRESS_CONVERT_LEADING_BYTES, bytes4(0x00000003), "ADDRESS_CONVERT_LEADING_BYTES selector should be correct");
    ...
    function test_IsValidDepositInvalidOutputsCountZero() public {
        ...
        btcTx.inputs[0] = SovaBitcoin.Input({
            prevTxHash: keccak256("prev"), outputIndex: 0, scriptSig: hex"47", witness: new bytes[](0)
        });
        btcTx.locktime = 0;
