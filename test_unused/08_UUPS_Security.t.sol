...
contract UUPSSecurityTest is Test {
    ...
    function test_StorageLayoutWithPendingOperations() public {
        ...
        assertEq(
            keccak256(bytes(newPendingDest)), keccak256(bytes(pendingDest)), "Pending destination should be preserved"
        );
    }
    ...
    function test_UpgradeToAndCall() public {
        ...
        bytes memory callData = abi.encodeWithSelector(MockUpgradeableSovaBTC.setMinDepositAmount.selector, 9999);
